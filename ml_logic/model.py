"""
Docstring for ml_logic.model
Gère le développement des modèles utilisés dans safer_food :
    - Initialisation
    - Entraînement
    - Évaluation
"""
class PredictionModel:
    """
    Docstring for PredictionModel
    Prediction models
        - PredictionModel() : creates an instance of our RNN model
